...
protected:
  ...
  void useLoopFunction(ruth::TaskFunc_t *func) { _loop_func = func; }
...
private:
  ...
  ruth::Task_t _task = {.handle = nullptr,
                        .data = nullptr,
...
private:
  void _start_(void *task_data = nullptr) {
    ...
    xTaskCreate(&runTask, _task_name.c_str(), _task.stackSize, _task.data, _task.priority, &_task.handle);
  }
